...
for  ant_temp = 1:antenna_num
    ...
    %%
    load(['E:\fuqiuhao\Raytraing_Platform\raytracing_matlab_simulation\ray_tracing_office_fuqiuhao\rayTracing_data\rayTracing_v2_indoor_tx1_rx1\20171207_wall_window\indoor_Rv0.2_antenna',num2str(ant_temp),'.mat']);
...
figure(2)
plot(1:antenna_num,-power_mea_dB,'-g',1:antenna_num,-pathloss_v1_dB-10,'-b',1:antenna_num,-pathloss_v2_dB(1:antenna_num,:)-10,'--r','linewidth',2);
%title('Path Loss')
xlabel('Antenna ID');
ylabel('Path Loss(dB)');
legend('Measured','Ray tracing simple','Ray tracing considering wall')
