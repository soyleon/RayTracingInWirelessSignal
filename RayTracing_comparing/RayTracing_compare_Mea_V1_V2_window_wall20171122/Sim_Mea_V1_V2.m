...
%%
    load(['E:\fuqiuhao\Raytraing_Platform\raytracing_matlab_simulation\ray_tracing_office_fuqiuhao\rayTracing_data\rayTracing_v2_indoor_tx1_rx1\20171121_polarity\indoor_Rv0.2_antenna',num2str(ant_temp),'.mat']);
...
% power_received_ray_v1_linear = 10.^(power_received_ray_dB_v1_temp./10);
 ...
 pathloss_v2_dB = power_sum_v2_dB-17;
 
 
 figure(2)
 plot(1:antenna_num,-power_mea_dB,'-g',1:antenna_num,-pathloss_v1_dB(1:antenna_num,:),'-b',1:antenna_num,-pathloss_v2_dB(1:antenna_num,:),'--r','linewidth',2);
 %title('Path Loss')
 xlabel('Antenna ID');
 ylabel('Path Loss(dB)');
