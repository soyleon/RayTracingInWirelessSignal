...
%%
    load(['E:\fuqiuhao\Raytraing_Platform\raytracing_matlab_simulation\ray_tracing_office_fuqiuhao\rayTracing_data\rayTracing_v2_indoor_tx1_rx1\20171110_wall_window\indoor_Rv0.2_antenna',num2str(ant_temp),'.mat']);
...
legend('Ray_tracing V1','Ray_tracing V2')
...
% power_received_ray_v1_linear = 10.^(power_received_ray_dB_v1_temp./10);
 ...
 power_sum_v1_dB = 10.*log10(power_sum_v1)+13;
 power_sum_v2_dB = 10.*log10(power_sum_v2)+30;
 ...
 %% RMS figure
 figure(3)
 plot(1:antenna_num,rms_delay_v1(1,1:antenna_num)-9,'-b',1:antenna_num,rms_delay_v2(1,1:antenna_num),'--r','linewidth',2);
 xlabel('Antenna ID');
