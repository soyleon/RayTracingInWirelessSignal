...
n_face = [n_window;n_floor_face;n_ceiling_face;n_leftwall_face;n_rightwall_face;n_frontwall_face;n_behindwall_face;n_obwall_face;n_obwall2_face;n_obwall3_face;n_obwall4_face];
...
plot3(p_desk1(:,1),p_desk1(:,2),p_desk1(:,3),'-');
...
plot3(p_desk1_face2(:,1),p_desk1_face2(:,2),p_desk1_face2(:,3),'-');
...
p_allface = [p_window,p_floor, p_ceiling, p_leftwall, p_rightwall,p_frontwall,p_behindwall,p_obwall,p_obwall2,p_obwall3,p_obwall4];
    ...
    for n = 1:num_theta
        for m = 1:num_phi(n)
            ...
            for i = 1:reflect_time
                ...
                [newray] = reflected_map(rp{1,i},v1,v2,v3,n_face);
